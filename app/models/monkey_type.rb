...
class MonkeyType < ApplicationRecord
  ...
  validates :scientific_name, length: { minimum: NAME_MIN_LENGTH, maximum: NAME_MAX_LENGTH }
  validates :colloquial_name, length: { minimum: NAME_MIN_LENGTH, maximum: NAME_MAX_LENGTH }
